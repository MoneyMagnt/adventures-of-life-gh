...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const travelStyles = {
    ...
    togo: {
      ...
      summary: "Three days into Togo, with city landmarks, portraits, and the first passport stamp of 2026 now fully on record.",
      audience: "Cross-border travellers · early joiners · people watching the map get bigger",
      includes: "Lome / border chapter / group portraits / road energy",
      visual: "Lome chapter",
      imgSrc: "assets/responsive/togo-group-garden-1440.webp",
      imgAlt: "Group picture from the Togo Vibe Experience.",
      highlights: ["3-day border run", "Lome chapter", "Group portraits", "Trip complete"],
      storyTitle: "Togo is properly on the wall now.",
      storySummary:
        "The first border run of the year came back with real frames: the cathedral steps, the road gathering, the portraits, and the kind of energy that makes the next international chapter easier to believe in.",
      gallery: [
        {
          src: "assets/responsive/togo-group-garden-1440.webp",
          alt: "Group picture from the Togo Vibe Experience.",
          kicker: "Group frame",
          title: "The first Togo chapter already has the kind of group picture that tells the whole mood in one frame.",
          accent: "accent-gold",
          position: "center center",
        },
        {
          src: "assets/responsive/togo-group-road-1440.webp",
          alt: "Group moment from the Togo Vibe Experience.",
          kicker: "On the move",
          title: "The border chapter worked because the group looked settled into it almost immediately.",
          accent: "accent-lagoon",
          position: "center center",
        },
        {
          src: "assets/responsive/togo-trio-1440.webp",
          alt: "Portrait frame from the Togo Vibe Experience.",
          kicker: "Portraits",
          title: "The people shots make it clear this was a real trip, not just a stamp on the map.",
          accent: "accent-sand",
          position: "center center",
        },
        {
          src: "assets/responsive/togo-sculpture-1440.webp",
          alt: "Sculpture stop during the Togo Vibe Experience.",
          kicker: "City detail",
          title: "Togo brought a different visual language into the year, and that matters too.",
          accent: "accent-canopy",
          position: "center center",
        },
      ],
      ...
      gallery: [
        {
          ...
          title: "This chapter is locked into the public 2026 release.",
          accent: "accent-gold",
          position: "center 14%",
        },
        {
